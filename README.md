...
### Describution
We used the code that ranked first, after that, we got the result are Mean Average Precision : 0.3731, Mean Average Recal1 : 0.6023 and the final ranking in the leaderboard is 6th.
